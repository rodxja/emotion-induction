...
public class SceneManagerSpiders : MonoBehaviour
{
    ...
    public SecondsAllowedSpiders seconds = SecondsAllowedSpiders.Five;
    ...
    void Awake()
    {
        ...
        //if (seconds == SecondsAllowedSpiders.Five)
        //{
        //    foreach (GameObject obj in targetObjects)
        //    {
        //        if (obj.CompareTag("Spiders")) {
